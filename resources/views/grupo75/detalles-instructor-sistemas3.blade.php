                            ...
                            <div class="card-body instructor-details">
                                <div class="instructor-img">
                                    <a href="javascript:void(0);">
                                        <img src="{{URL::asset('build/img/instructor/IngSistemasInstructor/IngOttoOrtizPerfil.jpeg')}}" alt="img" class="img-fluid">
                                    </a>
                                ...
                                <div class="flex-fill">
                                    <div class="pb-3 border-bottom mb-3">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <h6 class="fw-bold">Ing  Otto Rigoberto Ortíz Pérez</h6>
                                        </div>
                                        <div class="d-flex align-items-center mb-1">
                                            <p>Ingeniero en Sistemas de la Información y Ciencias de la Computación con Postgrado en Análisis y Predicción de Datos</p>
                                            <span class="me-2">
                                        ...
                                        <div>
                                            <p>Con experiencia como desarrollador de software</p>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="education-flow">
                                    ...
                                    <div class="ps-4 pb-4 timeline-flow">
                                        <div>
                                            <h6 class="mb-1">Postgrado en Análisis y Predicción de Datos</h6>
                                            <p class="fs-14"></p>
                                        </div>
                                    </div>
