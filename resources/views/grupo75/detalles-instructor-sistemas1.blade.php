                    ...
                    <div class="col-lg-8">
                            ...
                            <div class="card-body instructor-details">
                                <div class="instructor-img">
                                    <a href="javascript:void(0);">
                                        <img src="{{URL::asset('build/img/instructor/IngSistemasInstructor/IngOscarValientePerfil.jpg')}}" alt="img" class="img-fluid">
                                    </a>
                                ...
                                <div class="flex-fill">
                                    <div class="pb-3 border-bottom mb-3">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <h6 class="fw-bold">Ing Oscar Antonio Valiente Arreaga</h6>
                                        </div>
                                        <div class="d-flex align-items-center mb-1">
                                            <p>Coordinador de la Facultad de Ingeniería en Sistemas Centro UMG Guastatoya e Ingeniero en Sistemas de la Información y Ciencias de la Computación</p>
                                            <span class="me-2">
                                        ...
                                        <div>
                                            <p>Con experiencia en CiberSeguridad y Administración de Sistemas</p>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-3"> Ingeniero en Sistemas con especialización en infraestructura tecnológica y soluciones cloud. Cuento con certificaciones oficiales en AWS como Cloud Practitioner, en redes Cisco como CCNA, y como profesional en administración de sistemas Linux (LPIC 1-3). Mi experiencia combina la gestión académica como coordinador de facultad con la docencia universitaria, formando a la nueva generación de ingenieros con enfoque en tecnologías actuales y mejores prácticas de la industria.</p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="education-flow">
                                    ...
                                    <div class="ps-4 pb-4 timeline-flow">
                                        <div>
                                            <h6 class="mb-1">Administrador de Sistemas</h6>
                                            <p class="fs-14"></p>
                                        </div>
                                    </div>
                                    <div class="ps-4 pb-4 timeline-flow">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <span class="bg-light border avatar avatar-lg text-gray-9 flex-shrink-0 me-3"><i class="isax isax-briefcase"></i></span>
                                    <div>
                                        <h6 class="mb-1">Coordinador de Facultad de Ingeniería en Sistemas Centro UMG Guastatoya</h6>
