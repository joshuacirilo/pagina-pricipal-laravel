...
<div class="col-md-7">
    ...
    <div class="card-body ps-5 pe-4 pt-4 pb-4">
        ...
        <img src="{{ URL::asset('build/img/instructor/debora.png') }}" 
     alt="Instructor" 
     class="me-3"
     style="width: 190px; height: 190px; object-fit: cover; border-radius: 50%; border: 2px solid #dee2e6;">

            <div>
                <h4 class="fw-bold text-primary mb-1">Licda. Debora Anahid Soto Colindres</h4>
                <span class="text-muted d-block">Licenciada en Administración de Empresas</span>
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center mb-2 flex-wrap">
                ...
                <a href="javascript:void(0);" class="text-dark fw-medium me-3">edebora15@miumg.edu.gt</a>
        ...
        <div class="bg-light rounded-3 p-3 mb-3 d-flex justify-content-between align-items-center">
            ...
            <div class="text-end">
                <span class="badge bg-primary me-1">Administradora de empresas</span>
            </div>
        </div>
...
<div class="col-md-4">
    <div class="card shadow-lg border-0 rounded-4 h-100">
        <div class="card-body text-center">
            ...
            <p class="text-muted small mb-0">Licenciada en Administración de Empresas - UMG</p>
        </div>
    </div>
</div>
