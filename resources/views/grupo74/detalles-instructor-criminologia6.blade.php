...
<div class="col-md-7">
    ...
    <div class="card-body ps-5 pe-4 pt-4 pb-4">
        ...
        <img src="{{ URL::asset('build/img/instructor/docenteCrimi4.png') }}" 
     alt="Instructor" 
     class="me-3"
     style="width: 190px; height: 190px; object-fit: cover; border-radius: 50%; border: 2px solid #dee2e6;">

            <div>
                <h4 class="fw-bold text-primary mb-1">INGA. EVELYN RAQUEL CABRERA SÁNCHEZ </h4>
                <span class="text-muted d-block">Ingeniera en Sistemas de Información y Ciencias de la Computación </span>
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center mb-2 flex-wrap">
                ...
                <a href="javascript:void(0);" class="text-dark fw-medium me-3">eraquels16@miumg.edu.gt</a>
            ...
            <p class="text-muted mb-0">
                <div class="card-body ps-5 pe-4 pt-4 pb-4">
                Magister Artium en Dirección y Gestión de Recursos Humanos
                </div>    
            </p>
        ...
        <div class="bg-light rounded-3 p-3 mb-3 d-flex justify-content-between align-items-center">
            ...
            <div class="text-end">
                <span class="badge bg-primary me-1">Magister Artium en Dirección y Gestión de Recursos Humanos</span>
            </div>
        </div>
...
<div class="col-md-4">
    <div class="card shadow-lg border-0 rounded-4 h-100">
        <div class="card-body text-center">
            ...
            <p class="text-muted small mb-0">Licenciatura en Ingeniería en sistemas de informacion y ciencias de la computacion - UMG</p>
        </div>
    </div>
</div>
