...
<div class="col-md-7">
    ...
    <div class="card-body ps-5 pe-4 pt-4 pb-4">
        ...
        <img src="{{ URL::asset('build/img/instructor/2.png') }}" 
     alt="Instructor" 
     class="me-3"
     style="width: 190px; height: 190px; object-fit: cover; border-radius: 50%; border: 2px solid #dee2e6;">

            <div>
                <h4 class="fw-bold text-primary mb-1">Lic. Roberto Bladimir Roldán Cruz</h4>
                <span class="text-muted d-block">LICENCIADO EN CIENCIAS CRIMINOLOGÍA Y CRIMINALÍSTICA </span>
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center mb-2 flex-wrap">
                ...
                <a href="javascript:void(0);" class="text-dark fw-medium me-3">broldan45@miumg.edu.gt</a>
            ...
            <p class="text-muted mb-0">
                <div class="card-body ps-5 pe-4 pt-4 pb-4">
                La especialidad en Criminología se presenta como un campo fascinante y multidisciplinario que aborda el estudio del crimen, sus causas y efectos, así como las respuestas sociales y legales. Como docente en esta área, la experiencia es enriquecedora tanto para mí como  para los estudiantes, quienes se sumergen en un análisis crítico de la conducta delictiva.
                </div>    
            </p>
...
<div class="col-md-4">
    <div class="card shadow-lg border-0 rounded-4 h-100">
        <div class="card-body text-center">
            ...
            <p class="text-muted small mb-0">LICENCIADO EN CIENCIAS JURÍDICAS Y SOCIALES (ABOGADO Y NOTARIO) - UMG</p>
            
            <p class="text-muted small mb-0">LICENCIADO EN CIENCIAS CRIMINOLOGÍA Y CRIMINALÍSTICA  - UMG</p>
        </div>
    </div>
</div>
