            ...
            <div class="col-md-7">
                <div class="card shadow-lg border-0 rounded-4 h-100">
                    ...
                    <div class="bg-light rounded-3 p-3 mb-3 d-flex justify-content-between align-items-center">
                        ...
                        <h6 class="fw-bold mb-1 text-secondary ms-1">Especialidades:</h6>
                        <div class="text-end">
                    ...
                    <!-- Redes sociales -->
                    <div class="d-flex align-items-center justify-content-end pb-4 pe-4">
                ...
                <div class="card shadow-lg border-0 rounded-4 h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted small mb-0">
                            Especialización Universitaria en Análisis Forense Digital y Actuaciones como Primeros Respondientes - Valladolid
                        </p>
                    </div>
                </div>
            </div>
