...
<div class="col-md-7">
    ...
    <div class="card-body ps-5 pe-4 pt-4 pb-4">
        ...
        <img src="{{ URL::asset('build/img/instructor/docente1admi.jpg') }}"
     alt="Instructor"
     class="me-3"
     style="width: 190px; height: 190px; object-fit: cover; border-radius: 50%; border: 2px solid #dee2e6;">

            <div>
                <h4 class="fw-bold text-primary mb-1">Lic. Jose Humberto Martinez Morales</h4>
                <span class="text-muted d-block">Instructor Senior en Administración</span>
                <small class="text-secondary">UMG Guastatoya | 14 años de experiencia</small>
            </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center mb-2 flex-wrap">
                ...
                <span class="me-2 fw-semibold text-muted">Especialidad en:</span>
                <a href="javascript:void(0);" class="text-dark fw-medium me-3">Administración</a>
            ...
            <p class="text-muted mb-0">
                <div class="card-body ps-5 pe-4 pt-4 pb-4">
                Profesional con una sólida formación en Administración de Empresas, capaz de planificar, organizar y gestionar
                 recursos humanos, financieros y operativos dentro de una organización. Posee habilidades para la toma de
                 decisiones estratégicas, optimización de procesos y liderazgo de equipos, contribuyendo al crecimiento y
        ...
        <div class="bg-light rounded-3 p-3 mb-3 d-flex justify-content-between align-items-center">
            ...
            <div class="text-end">
                <span class="badge bg-primary me-1">Administración Financiera</span>
                <span class="badge bg-success me-1">Administración de Operaciones</span>
                <span class="badge bg-info text-dark">Administración de Mercado</span>
            </div>
        </div>
...
<div class="col-md-4">
    <div class="card shadow-lg border-0 rounded-4 h-100">
        <div class="card-body text-center">
            ...
            <p class="text-muted small mb-0">Licenciado en Administración de Empresas <br> Maestria en docencia Superior</p>
        </div>
    </div>
</div>
