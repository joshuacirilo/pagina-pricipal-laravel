/**
 * UMG Auditoria — sticky stacked cards + ScrollTrigger scrub.
 * Expects globals: gsap, ScrollTrigger (vendor scripts).
 */
(function () {
  "use strict";

  var root = document.querySelector("[data-umg-auditoria-story]");
  ...
  var cards = Array.prototype.slice.call(root.querySelectorAll(".umg-auditoria-story__card"));
  ...
  function killAll() {
    ...
    cards.forEach(function (card) {
      var inner = card.querySelector(".umg-auditoria-story__card-inner");
      var img = card.querySelector(".umg-auditoria-story__img");
      var dim = card.querySelector("[data-story-dim]");
      var title = card.querySelector(".umg-auditoria-story__title");
      var desc = card.querySelector(".umg-auditoria-story__desc");
      var words = card.querySelectorAll(".umg-auditoria-story__word");
      var paths = card.querySelectorAll(".umg-auditoria-story__path");
