/**
 * UMG Criminologia — sticky stacked cards + ScrollTrigger scrub.
 * Expects globals: gsap, ScrollTrigger (vendor scripts).
 */
(function () {
  "use strict";

  var root = document.querySelector("[data-umg-criminologia-story]");
  ...
  var cards = Array.prototype.slice.call(root.querySelectorAll(".umg-criminologia-story__card"));
  ...
  function killAll() {
    ...
    cards.forEach(function (card) {
      var inner = card.querySelector(".umg-criminologia-story__card-inner");
      var img = card.querySelector(".umg-criminologia-story__img");
      var dim = card.querySelector("[data-story-dim]");
      var title = card.querySelector(".umg-criminologia-story__title");
      var desc = card.querySelector(".umg-criminologia-story__desc");
      var words = card.querySelectorAll(".umg-criminologia-story__word");
      var paths = card.querySelectorAll(".umg-criminologia-story__path");
