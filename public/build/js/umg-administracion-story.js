/**
 * UMG Administracion — sticky stacked cards + ScrollTrigger scrub.
 * Expects globals: gsap, ScrollTrigger (vendor scripts).
 */
(function () {
  "use strict";

  var root = document.querySelector("[data-umg-administracion-story]");
  ...
  var cards = Array.prototype.slice.call(root.querySelectorAll(".umg-administracion-story__card"));
  ...
  function killAll() {
    ...
    cards.forEach(function (card) {
      var inner = card.querySelector(".umg-administracion-story__card-inner");
      var img = card.querySelector(".umg-administracion-story__img");
      var dim = card.querySelector("[data-story-dim]");
      var title = card.querySelector(".umg-administracion-story__title");
      var desc = card.querySelector(".umg-administracion-story__desc");
      var words = card.querySelectorAll(".umg-administracion-story__word");
      var paths = card.querySelectorAll(".umg-administracion-story__path");
