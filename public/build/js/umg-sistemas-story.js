/**
 * UMG Sistemas — sticky stacked cards + ScrollTrigger scrub.
 * Expects globals: gsap, ScrollTrigger (vendor scripts).
 */
(function () {
  "use strict";

  var root = document.querySelector("[data-umg-sistemas-story]");
  ...
  var cards = Array.prototype.slice.call(root.querySelectorAll(".umg-sistemas-story__card"));
  ...
  function killAll() {
    ...
    cards.forEach(function (card) {
      var inner = card.querySelector(".umg-sistemas-story__card-inner");
      var img = card.querySelector(".umg-sistemas-story__img");
      var dim = card.querySelector("[data-story-dim]");
      var title = card.querySelector(".umg-sistemas-story__title");
      var desc = card.querySelector(".umg-sistemas-story__desc");
      var words = card.querySelectorAll(".umg-sistemas-story__word");
      var paths = card.querySelectorAll(".umg-sistemas-story__path");
