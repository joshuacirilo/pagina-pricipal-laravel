/**
 * UMG Trabajo Social — sticky stacked cards + ScrollTrigger scrub.
 * Expects globals: gsap, ScrollTrigger (vendor scripts).
 */
(function () {
  "use strict";

  var root = document.querySelector("[data-umg-trabajo-social-story]");
  ...
  var cards = Array.prototype.slice.call(root.querySelectorAll(".umg-trabajo-social-story__card"));
  ...
  function killAll() {
    ...
    cards.forEach(function (card) {
      var inner = card.querySelector(".umg-trabajo-social-story__card-inner");
      var img = card.querySelector(".umg-trabajo-social-story__img");
      var dim = card.querySelector("[data-story-dim]");
      var title = card.querySelector(".umg-trabajo-social-story__title");
      var desc = card.querySelector(".umg-trabajo-social-story__desc");
      var words = card.querySelectorAll(".umg-trabajo-social-story__word");
      var paths = card.querySelectorAll(".umg-trabajo-social-story__path");
